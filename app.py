...
st.set_page_config(page_title="QuLab: Lab 29: Summarizing a 10-K with RAG", layout="wide")
...
api_key_input = st.sidebar.text_input("OpenAI API Key", type="password", help="Enter your OpenAI API Key (e.g., sk-...)", value=st.session_state['openai_api_key'])
if api_key_input:
    st.session_state['openai_api_key'] = api_key_input
    client_llm.api_key = api_key_input
